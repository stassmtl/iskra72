...
$query = "SELECT request.id as id, user.full_name as FIO,  car.name as car_name, status.name as status_name, user.phone as phone, user.email as email, booking_date, id_status   FROM `request` 
